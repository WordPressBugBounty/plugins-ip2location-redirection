...
== Changelog ==
* 1.40.2 Added validation for same page redirection.
* 1.40.1 Fixed WPML language code not being read during redirection.
* 1.40.0 Added redirection with any countries. Other fixes and improvements.
* 1.39.2 Fixed API Key validation issue.
* 1.39.1 Tested up to WordPress 7.0.
* 1.39.0 Added option to skip AI bots.
* 1.38.1 Fixed restore function error.
